...
namespace DarkLibCW.Controllers
{
    public class SubscribersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LastName,Name,MidName,Age,Gender,UserName")] Subscriber subscriber)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LastName,Name,MidName,Age,Gender,UserName")] Subscriber subscriber)
        {
            if (id != subscriber.Id)
            {
                return NotFound();
