...
namespace DarkLibCW.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LastName,Name,MidName")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LastName,Name,MidName")] Author author)
        {
            if (id != author.Id)
            {
                return NotFound();
