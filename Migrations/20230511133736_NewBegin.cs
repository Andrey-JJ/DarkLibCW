        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CatalogCards_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CatalogCards_Editions_EditionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MidName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CatalogCardId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Books_CatalogCards_CatalogCardId",
                        column: x => x.CatalogCardId,
                        principalTable: "CatalogCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Subscribers_SubscriberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Issues_Librarians_LibrarianId",
                        column: x => x.LibrarianId,
                        principalTable: "Librarians",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Issues_Subscribers_SubscriberId",
                        column: x => x.SubscriberId,
                        principalTable: "Subscribers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_SubscriberId",
                table: "Bookings",
                column: "SubscriberId");

            migrationBuilder.CreateIndex(
                name: "IX_Books_CatalogCardId",
                table: "Books",
                column: "CatalogCardId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CatalogCards_CategoryId",
                table: "CatalogCards",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CatalogCards_EditionId",
                table: "CatalogCards",
                column: "EditionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Issues_LibrarianId",
                table: "Issues",
                column: "LibrarianId");

            migrationBuilder.CreateIndex(
                name: "IX_Issues_SubscriberId",
                table: "Issues",
                column: "SubscriberId");
        }
